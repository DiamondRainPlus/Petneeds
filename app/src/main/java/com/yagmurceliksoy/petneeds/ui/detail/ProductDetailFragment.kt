package com.yagmurceliksoy.petneeds.ui.detail
...
import com.yagmurceliksoy.petneeds.common.loadImage
...
import com.yagmurceliksoy.petneeds.databinding.FragmentProductDetailBinding
        ...
        viewModel.productDetailState.observe(viewLifecycleOwner) { state ->
            when (state) {
                ...
                is ProductDetailState.Data -> {
                    ...
                    val scaledRating = (state.productResponse?.rate?.toFloat()!! / 5.0f) * 100.0f
